...
class AutoNPC() :
    def __init__(self, apikey) :
        ...
        self.template = """
                ...
                name : 게임 NPC 이름 story : 게임 NPC 스토리 quest1 : 퀘스트 1 이름 quest1_story : 퀘스트 1 스토리 quest1_goal : 퀘스트 1 목표 quest1_reward : 퀘스트 1 보상 quest2 : 퀘스트 2 이름 quest2_story : 퀘스트 2 스토리 quest2_goal : 퀘스트 2 목표 quest2_reward : 퀘스트 2 보상 quest3 : 퀘스트 3 이름 quest3_story : 퀘스트 3 스토리 , quest3_goal : 퀘스트 3 목표 quest3_reward : 퀘스트 3 보상 quest4 : 퀘스트 4 이름 quest4_story : 퀘스트 4 스토리 quest4_goal : 퀘스트 4 목표 quest4_reward : 퀘스트 4 보상
    ...
    def run(self, genre="판타지", ambient="평화로움", job="기사", brood="인간", language="영어") :
        return self.chain.run({"genre" : genre, "ambient" : ambient, "job" : job, "brood" : brood, "language" : language})

autoNpc = AutoNPC()
answer = autoNpc.run("다크 판타지", "혼돈", "기사", "인간", "한국어") #list
print(answer)
